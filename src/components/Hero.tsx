...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Geometric Accents */}
      <div className="absolute top-20 left-20 w-32 h-32 border border-amber-400/20 rotate-45 z-10"></div>
      <div className="absolute bottom-32 right-20 w-24 h-24 bg-amber-400/5 rotate-12 z-10"></div>
      ...
      >
        {/* Badge */}
        <motion.div 
        className="inline-flex items-center space-x-3 bg-amber-400/5 backdrop-blur-sm rounded-none px-8 py-4 border border-amber-400/20"
        ...
        {/* Subtitle */}
        <motion.p 
        className="text-xl md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed font-light tracking-wide drop-shadow-lg"
        ...
        >
        <button className="group bg-gradient-to-r from-amber-400 to-amber-500 text-black px-12 py-5 rounded-none font-bold text-lg tracking-wider hover:from-amber-500 hover:to-amber-600 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-2xl">
          <span>START YOUR IMPACT</span>
          <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
        </button>
        <button className="group bg-transparent border-2 border-white/30 text-white px-12 py-5 rounded-none font-bold text-lg tracking-wider hover:bg-white/5 hover:border-white/50 transition-all duration-300 flex items-center justify-center space-x-3 backdrop-blur-sm">
